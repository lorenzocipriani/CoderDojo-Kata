 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU General Public License 2.0 or later
 */
class SkinCoderDojoKataNinjas2 extends SkinTemplate
{
	var $skinname = 'coderdojokataninjas2';
	var $stylename = 'CoderDojoKataNinjas2';
	var $template = 'CoderDojoKataNinjas2Template';
	...
	*/
	...
	function setupSkinUserCss( OutputPage $out ) 
	{
		...
		$out->addModuleStyles( 'skins.coderdojokataninjas2' );
	}
 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU General Public License 2.0 or later
 */
class CoderDojoKataNinjas2Template extends BaseTemplate
{
	/**
...
<?php include 'resources/ninjas2.tpl.php';?>
