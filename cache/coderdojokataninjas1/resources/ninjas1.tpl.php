					...
					<div class="row kata-ninjas-group">
						...
						<div class="col-xs-12 kata-ninjas-content">
							<div class="video-block">
								<div class="title">1. Game name</div>
								<div class="ratings-panel">
									<img src="http://placekitten.com/g/400/250"> <span
							...
							<div class="video-block">
								<div class="title">3. Game name</div>
								<div class="ratings-panel">
									<img src="http://placekitten.com/g/400/250"> <span
										class="star-rating"> <input type="radio" name="rating"
										value="1"><i></i> <input type="radio" name="rating" value="2"><i></i>
							...
							<div class="video-block">
								<div class="title">4. Game name</div>
								<div class="ratings-panel">
									<img src="http://placekitten.com/g/400/250"> <span
										class="star-rating"> <input type="radio" name="rating"
										value="1"><i></i> <input type="radio" name="rating" value="2"><i></i>
							...
							<div class="video-block">
								<div class="title">5. Game name</div>
								<div class="ratings-panel">
									<img src="http://placekitten.com/g/400/250"> <span
										class="star-rating"> <input type="radio" name="rating"
										value="1"><i></i> <input type="radio" name="rating" value="2"><i></i>
			...
			<div id="sectionB" class="tab-pane fade">
				<div class="panel-body">
					<div class="row kata-ninjas-group">
						...
						<!-- languages -->
						<div class="col-xs-12 kata-ninjas-heading">
							<h4>Top 5 Tutorials</h4>
						</div>
						<div class="col-xs-12 kata-ninjas-content">
							<div class="video-block">
								<div class="title">1. Tutorial name</div>
								<div class="ratings-panel">
									<img src="http://placekitten.com/g/400/250"> <span
										class="star-rating"> <input type="radio" name="rating"
										value="1"><i></i> <input type="radio" name="rating" value="2"><i></i>
								...
								<div class="link">
									<a href="#">link to tutorial</a>
								</div>
							</div>
							<div class="video-block">
								<div class="title">2. Tutorial name</div>
								<div class="ratings-panel">
									<img src="http://placekitten.com/g/400/250"> <span
										class="star-rating"> <input type="radio" name="rating"
										value="1"><i></i> <input type="radio" name="rating" value="2"><i></i>
							...
							<div class="video-block">
								<div class="title">3. Tutorial name</div>
								<div class="ratings-panel">
									<img src="http://placekitten.com/g/400/250"> <span
										class="star-rating"> <input type="radio" name="rating"
										value="1"><i></i> <input type="radio" name="rating" value="2"><i></i>
							...
							<div class="video-block">
								<div class="title">4. Tutorial name</div>
								<div class="ratings-panel">
									<img src="http://placekitten.com/g/400/250"> <span
										class="star-rating"> <input type="radio" name="rating"
										value="1"><i></i> <input type="radio" name="rating" value="2"><i></i>
							...
							<div class="video-block">
								<div class="title">5. Tutorial name</div>
								<div class="ratings-panel">
									<img src="http://placekitten.com/g/400/250"> <span
										class="star-rating"> <input type="radio" name="rating"
										value="1"><i></i> <input type="radio" name="rating" value="2"><i></i>
			...
			<div id="sectionC" class="tab-pane fade">
				<div class="panel-body">
					<div class="row kata-ninjas-group">
						...
						<div class="col-xs-12 kata-ninjas-content">
							<div class="kata-tags single-column featured-video">
				...
				<div class="panel-body">
					<div class="row kata-ninjas-group">
						...
						<div class="col-xs-12 kata-ninjas-content">
							<div class="kata-tags single-column more-video">
								<div class="description">
									<div class="title">Video Title</div>
									<div>Lorem Ipsum is simply dummy text of the printing and
										typesetting industry. Lorem Ipsum has been the industry's
