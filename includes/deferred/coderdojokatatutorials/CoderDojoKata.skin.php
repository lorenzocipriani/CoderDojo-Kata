 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU General Public License 2.0 or later
 */
class SkinCoderDojoKataTutorials extends SkinTemplate
{
	var $skinname = 'coderdojokatatutorials';
	var $stylename = 'CoderDojoKataTutorials';
	var $template = 'CoderDojoKataTutorialsTemplate';
	...
	*/
	...
	function setupSkinUserCss( OutputPage $out ) 
	{
		...
		$out->addModuleStyles( 'skins.coderdojokatatutorials' );
	}
 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU General Public License 2.0 or later
 */
class CoderDojoKataTutorialsTemplate extends BaseTemplate
{
	/**
...
<?php include 'resources/tutorials.tpl.php';?>
