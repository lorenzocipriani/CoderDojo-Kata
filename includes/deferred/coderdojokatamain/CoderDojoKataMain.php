...
$wgValidSkinNames['coderdojokatamain'] = 'CoderDojoKataMain';
 
$wgAutoloadClasses['SkinCoderDojoKataMain'] = __DIR__ . '/CoderDojoKata.skin.php';
$wgMessagesDirs['CoderDojoKata'] = __DIR__ . '/i18n';

$wgResourceModules['skins.coderdojokatamain'] = array(
	'styles' => array(
		...
		'coderdojokatamain/resources/screen.css' => array( 'media' => 'screen' )
	),
