<?php
/**
 * CoderdojoKata - Modern version of MonoBook with fresh look and many usability
 * improvements.
 *
...
/**
 * SkinTemplate class for CoderdojoKata skin
 * @ingroup Skins
 */
class SkinCoderdojoKata extends SkinTemplate {
	...
	var $skinname = 'coderdojokata', $stylename = 'coderdojokata',
		$template = 'CoderdojoKataTemplate', $useHeadElement = true;
	...
	public function initPage( OutputPage $out ) {
		...
		$out->addModules( array( 'skins.coderdojokata.js', 'skins.vector.collapsibleNav' ) );
	}
	...
	function setupSkinUserCss( OutputPage $out ) {
		...
		// $styles = array( 'mediawiki.skinning.interface', 'skins.vector.styles', 'skins.coderdojokata', 'skins.coderdojokata.styles' );
		$styles = array( 'mediawiki.skinning.interface', 'skins.coderdojokata.styles'  );
		wfRunHooks( 'SkinCoderdojoKataStyleModules', array( $this, &$styles ) );
...
/**
 * QuickTemplate class for CoderdojoKata skin
 * @ingroup Skins
 */
