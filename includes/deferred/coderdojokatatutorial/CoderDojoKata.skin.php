 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU General Public License 2.0 or later
 */
class SkinCoderDojoKataTutorial extends SkinTemplate
{
	var $skinname = 'coderdojokatatutorial';
	var $stylename = 'CoderDojoKataTutorial';
	var $template = 'CoderDojoKataTutorialTemplate';
	...
	*/
	...
	function setupSkinUserCss( OutputPage $out ) 
	{
		...
		$out->addModuleStyles( 'skins.coderdojokatatutorial' );
	}
 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU General Public License 2.0 or later
 */
class CoderDojoKataTutorialTemplate extends BaseTemplate
{
	/**
...
<?php include 'resources/tutorial.tpl.php';?>
